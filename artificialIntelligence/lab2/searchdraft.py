...
def uniformCostSearch(problem):
  ...
  x=[]
  visted=[]
  stack = PriorityQueueWithFunction(f)
  ...
  while stack:
    ...
    if not currentPostion[0] in visted:
      sList = problem.getSuccessors(currentPostion[0])
      for s in sList:
        stack.push((s[0], currentPostion[1] + [s[1]], currentPostion[2]+s[2]))
      visted=visted+[currentPostion[0]]
...
def aStarSearch(problem, heuristic=nullHeuristic):
  ...
  while stack:
    ...
    if problem.isGoalState(currentPostion[0]):
      break
    elif not currentPostion[0] in visted:
      SuccessorsList = problem.getSuccessors(currentPostion[0])
      for s in SuccessorsList:
        stack.push((s[0], move + [s[1]], currentPostion[2]+s[2]))
      visted=visted+[currentPostion[0]]
  return move
