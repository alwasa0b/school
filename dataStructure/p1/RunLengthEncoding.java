...
public class RunLengthEncoding {
   ...
   */
	...
	private int[] runLengths,runTypes,fed;
	private TypeAndSize col;
	public class DListOcean {
		  ...
		  public int item;
		  public DListOcean prev;
		  public DListOcean next;
  ...
  public RunLengthEncoding(int i, int j, int starveTime) {
    // Your solution here.
	  ...
	  col= new TypeAndSize(Ocean.EMPTY,this.width*this.height);
	  runTypes[0]=col.type;
	  runLengths[0]=col.size;
  ...
  public RunLengthEncoding(int i, int j, int starveTime,
    ...
    // Your solution here.
	  ...
	  for (int x =0,f=0 ; x<runTypes.length;x++){
		  this.runTypes[x]=runTypes[x];
		  this.runLengths[x]=runLengths[x];
		
		  if(this.runTypes[x]==Ocean.SHARK){
			  fed[f++]=starveTime;
		  }
	  }
