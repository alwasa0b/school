...
public class SimText {
  ...
  private static int i = 100;                             // Default ocean width
  private static int j = 10;                            // Default ocean height
  private static int starveTime =10;           // Default shark starvation time
