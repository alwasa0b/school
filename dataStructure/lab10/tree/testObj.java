...
public class testObj extends Tree {
 ...
 * @throws InvalidNodeException 
  ...
  public static void main(String[] args) throws InvalidNodeException {
	  TreeNode r,r1;
	  Tree t = new testObj(new Integer(11));
	  
	  t.insertRoot(1);
	  r=t.root();
	  
	  //r.insertChild(new Integer(13), 1);
	    //r.insertChild(new Integer(13),1000);
	    r.insertChild(new Integer(12), 1);
	    r.insertChild(new Integer(13), 2);
	    r.insertChild(new Integer(11), 0);
	    TreeNode r2 = r.child(3);
	    //TreeNode r3 = r.child(2);
	    r2.insertChild(new Integer(132), 1);
	    //r3.insertChild(new Integer(131), 1);
	 // t.root().insertChild(8,2);
	 // t.root().insertChild(5, 51);
	  //t.root().insertChild(20, 0);
	//  t.root().insertChild(8, 1);
	 // t.root().insertChild(8, 1);
	 // t.root().insertChild(7, 50);
	 // t.root().insertChild(8, 50);
	 // t.root().insertChild(9, 55);
	
	    
	  System.out.println(t.root().child(2).valid);
	  System.out.println(t.size);
	  System.out.println();
	  System.out.println(t.root().child(5).item);
	  System.out.println();
	  System.out.println();
