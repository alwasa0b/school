...
/**
 * @class berkeley cs61b Lab 4 Solution
...
public class DList2 {
	...
	public void insertFront(int i) {
		...
		if(size == 0){
			...
			DListNode2 currentHead = new DListNode2(head.next.item);
			DListNode2 newHead = new DListNode2(i);
	...
	public static void main(String[] args) {
		...
		if (l.head.next.item != 9) {
			System.out.println(l.head.next.item +" head.next.item is wrong.");
		}
		...
		if (l.head.prev.prev != l.head.next.next) {
			System.out.println("l.head.prev.prev != l.head.next.");
		}
		if (l.size != 3) {
			System.out.println("size is wrong.");
