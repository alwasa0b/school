...
public class Keyboard
{
   ...
   protected String current_token = null;
   ...
   protected String getNextToken() {return getNextToken (true);}
 
   //-----------------------------------------------------------------
   //  Gets the next input token, which may already have been read.
   //-----------------------------------------------------------------
 
   protected String getNextToken (boolean skip)
   {  String token;
   ...
   protected String getNextInputToken (boolean skip)
